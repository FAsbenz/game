    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv0 = v.texcoord0;
                float4 node_6852 = _Time + _TimeEditor;
                float2 node_7739 = (o.uv0+node_6852.g*float2(-0.01,0));
...
////// Lighting:
                float4 node_6852 = _Time + _TimeEditor;
                float2 node_3517 = (i.uv0+node_6852.g*float2(0.02,0));
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                VertexOutput o = (VertexOutput)0;
                o.uv0 = v.texcoord0;
                float4 node_3932 = _Time + _TimeEditor;
                float2 node_7739 = (o.uv0+node_3932.g*float2(-0.01,0));
                float4 node_1804 = tex2Dlod(_node_5770,float4(TRANSFORM_TEX(node_7739, _node_5770),0.0,0));
                float node_1087 = ((node_1804.r*_bodong)+_gaodu);
                v.vertex.xyz += float3(node_1087,node_1087,node_1087);
                o.pos = UnityObjectToClipPos(v.vertex );
