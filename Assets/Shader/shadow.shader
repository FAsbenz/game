...
////// Lighting:
                ...
                float node_9708 = pow(abs(dot(normalDirection,halfDirection)),exp2(((_Gloss_copy_copy_copy_copy_copy*10.0)+1.0))); // Specular Light
                float3 finalColor = ((_node_7708_var.rgb*_LightColor0.rgb*attenuation)+(node_9708*_LightColor0.rgb*attenuation*7.0)+(node_9708*attenuation));
