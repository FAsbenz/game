    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_6955 = ((node_1498+abs(node_1498)+abs(sin((node_4811*node_3739))))*_fudu);
                v.vertex.xyz += float3(node_6955,node_6955,node_6955);
...
////// Lighting:
                ...
                float3 finalColor = (((_darkcoler.rgb*pow(attenuation,(-0.3)))+(step(_bianyuan,attenuation)*_lightstrong*_lightcoler.rgb))*_LightColor0.rgb*(i.uv0.g+0.5));
