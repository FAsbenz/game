...
////// Lighting:
                ...
                float node_6687 = step(1.0,(dot(i.bitangentDir,0.87)+attenuation));
                float3 finalColor = ((_darkcoler.rgb+(node_6687*_lightstrong*_lightcoler.rgb))*_LightColor0.rgb*(i.uv0.g+0.5));
