...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float node_8610 = (_S*node_7896);
                float3 specColor = float3(node_8610,node_8610,node_8610);
                float roughness = 1.0 - (_G*node_7896);
