    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_704 = (o.uv0+node_927.g*float2(0,0.01));
...
////// Lighting:
                ...
                float3 finalColor = (attenuation*node_862*_faguang*_LightColor0.rgb);
                float4 node_927 = _Time + _TimeEditor;
                float2 node_704 = (i.uv0+node_927.g*float2(0,0.01));
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_704 = (o.uv0+node_9791.g*float2(0,0.01));
                float4 _node_3458_var = tex2Dlod(_node_3458,float4(TRANSFORM_TEX(node_704, _node_3458),0.0,0));
                float node_4869 = (sin((node_3249.g+(o.uv0.r*_pinglv)+_node_3458_var.r+(o.uv0.g*_pinglv)))*_bodong);
                v.vertex.xyz += float3(node_4869,node_4869,node_4869);
                float3 lightColor = _LightColor0.rgb;
...
////// Lighting:
                ...
                float3 finalColor = (attenuation*node_862*_faguang*_LightColor0.rgb);
                float4 node_9791 = _Time + _TimeEditor;
                float2 node_704 = (i.uv0+node_9791.g*float2(0,0.01));
                float4 _node_3458_var = tex2D(_node_3458,TRANSFORM_TEX(node_704, _node_3458));
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv0 = v.texcoord0;
                float4 node_3249 = _Time + _TimeEditor;
                float4 node_213 = _Time + _TimeEditor;
                float2 node_704 = (o.uv0+node_213.g*float2(0,0.01));
                float4 _node_3458_var = tex2Dlod(_node_3458,float4(TRANSFORM_TEX(node_704, _node_3458),0.0,0));
                float node_4869 = (sin((node_3249.g+(o.uv0.r*_pinglv)+_node_3458_var.r+(o.uv0.g*_pinglv)))*_bodong);
                v.vertex.xyz += float3(node_4869,node_4869,node_4869);
                o.pos = UnityObjectToClipPos(v.vertex );
