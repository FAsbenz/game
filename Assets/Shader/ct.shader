...
/////// Diffuse:
                ...
                float3 diffuseColor = (((_darkcoler.rgb*pow(attenuation,(-0.5)))+(step(_bianyuan,attenuation)*_lightstrong*_lightcoler.rgb*(_norqiangdu+step(max(0,dot(i.bitangentDir,viewReflectDirection)),_norbianyuan))))*_diffuse_var.rgb*_LightColor0.rgb);
