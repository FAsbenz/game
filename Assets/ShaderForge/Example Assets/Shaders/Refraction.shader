...
////// Specular:
                ...
                float node_5349 = 0.2;
                float3 diffuseColor = float3(node_5349,node_5349,node_5349); // Need this for specular when using metallic
